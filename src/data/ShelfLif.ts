...
const WEEKDAY_PT_BR = ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'] as const;
...
export const ShelfLif = {
  description: 'Tabela semanal de segunda a domingo (virada de validade na segunda às 00:00 de São Paulo)',
